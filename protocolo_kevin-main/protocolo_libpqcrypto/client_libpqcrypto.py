...
def encapsulado(id):
    ...
    # Se realiza el encapsulado y obtenemos el CT y el PT
    ciphertext, plaintext_original = kem.enc(public_key)
    # Enviamos el CT
...
try:
    ...
    signature = sock.recv(2076, socket.MSG_WAITALL)
    ...
    print(mi == dilithium2.open(signature, public_key_sign))
    # FINFASE2
